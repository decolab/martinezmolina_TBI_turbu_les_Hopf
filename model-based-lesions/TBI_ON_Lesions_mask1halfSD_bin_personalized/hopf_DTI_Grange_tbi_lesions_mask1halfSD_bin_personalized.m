...
function hopf_DTI_Grange_tbi_lesions_mask1halfSD_bin_personalized(s,condition)
...
for sbj=1:NSUB
    ...
    for sub=1:NSUBSIM
        ...
        %%
        Turbulence(sub)=Rsub;
        save(sprintf('WG_%03d_%d_sub_%d_ON_tbi_mask1halfSD_bin.mat',s,condition,sbj),'InfoCascade','InfoFlow','Turbulence','err_hete');
    end
end