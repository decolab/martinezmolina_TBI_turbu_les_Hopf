...
clear all
close all
addpath('/Volumes/LASA/TBI_OpenNeuro/TBI_openneuro/Hopf_model/TBI_ON_Hopf_hc_tp2/outputs/Grange/');
addpath('/Volumes/LASA/TBI_OpenNeuro/Shared_code/TBI_ON_Lesions_Hopf_mask2SD_weight/')
addpath('/Volumes/LASA/TBI_OpenNeuro/TBI_openneuro/Hopf_model/TBI_ON_Lesions_Hopf_mask2SD_weight_corr/outputs/Grange/');
outdir='/Volumes/LASA/TBI_OpenNeuro/TBI_openneuro/Hopf_model/TBI_ON_Lesions_Hopf_mask2SD_weight_corr/outputs/Grange/optG/';
...
for cond=1:3
    if cond==1
        tbi_cond1=load_condition_tbi_mask2SD_weight(G,cond);
    elseif cond==2
        tbi_cond2=load_condition_tbi_mask2SD_weight(G,cond);
    else 
         tbi_cond3=load_condition_tbi_mask2SD_weight(G,cond);
    end
end
...
cd (outdir)
save('optG_tbi_mask2SD_weight.mat','optG_tbicond1', 'optG_tbicond2','optG_tbicond3')
...
print('Global coupling Fitting Open Neuro TP123 (N=24)','-dpng')
saveas(gcf,'Global coupling Fitting Open Neuro TP123 (N=24)','fig')