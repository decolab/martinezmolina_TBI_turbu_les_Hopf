...
function hopf_DTI_Grange_tbi_lesions_mask_2SD_weight(s,condition)
...
load('lesion_mask_2SD_weighted.mat')
...
C=C.*lesion_mask_2SD_weighted; % MULTIPLY BY LESION MASK AVERAGED ACROSS TBI PATIENTS
...
save(sprintf('WG_%03d_%d_ON_tbi_mask2SD_weight.mat',s,condition),'InfoCascade','InfoFlow','Turbulence','err_hete');
