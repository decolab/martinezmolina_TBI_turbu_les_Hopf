...
load('lesion_mask_2SD_weighted.mat') % lesion mask thresholded at 2 std and averaged across TBI patients (weighted approach)
...
C=C.*lesion_mask_2SD; % MULTIPLY BY LESION MASK AVERAGED ACROSS TBI PATIENTS
...
save(sprintf('Wtrials_%03d_%d_%s_ON_tbi_mask2SD_weight.mat',s,condition,measure),'infocapacity','susceptibility');
