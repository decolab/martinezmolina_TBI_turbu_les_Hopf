clear all;
addpath('/Volumes/LASA/TBI_OpenNeuro/TBI_openneuro/Hopf_model/TBI_ON_Lesions_Hopf_mask1halfSD_bin/outputs/Trials/');
addpath('/Volumes/LASA/TBI_OpenNeuro/Shared_code/TBI_ON_Lesions_Hopf_mask1halfSD_bin/');
trials=100;
groups={'tbi_tp1','tbi_tp2','tbi_tp3'};

tbi_cond1=load_condition_tbi_mask1halfSD_bin(trials,1);
tbi_cond2=load_condition_tbi_mask1halfSD_bin(trials,2);
tbi_cond3=load_condition_tbi_mask1halfSD_bin(trials,3);
...
print('Information capacity & susceptibility TBI Open Neuro N=24 TP123 Lesion Mask 1halfSD bin', '-dpng')
