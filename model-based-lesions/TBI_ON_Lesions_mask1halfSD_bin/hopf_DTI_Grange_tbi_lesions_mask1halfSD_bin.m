...
function hopf_DTI_Grange_tbi_lesions_mask1halfSD_bin(s,condition)
...
load('lesion_mask_1andhalfSD.mat')
...
C=C.*lesion_mask_1andhalfSD; % MULTIPLY BY LESION MASK AVERAGED ACROSS TBI PATIENTS
...
save(sprintf('WG_%03d_%d_ON_tbi_mask1halfSD_bin.mat',s,condition),'InfoCascade','InfoFlow','Turbulence','err_hete');
