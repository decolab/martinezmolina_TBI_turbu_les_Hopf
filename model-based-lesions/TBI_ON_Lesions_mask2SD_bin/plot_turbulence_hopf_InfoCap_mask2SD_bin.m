clear all;
addpath('/Volumes/LASA/TBI_OpenNeuro/TBI_openneuro/Hopf_model/TBI_ON_Lesions_Hopf_mask2SD_bin/outputs/Trials/');
...
print('Information capacity & susceptibility TBI Open Neuro N=24 TP123 Lesion Mask 2SD bin', '-dpng')
