...
function hopf_DTI_Grange_tbi_lesions_mask_2SD_bin(s,condition)
...
save(sprintf('WG_%03d_%d_ON_tbi_mask2SD_bin.mat',s,condition),'InfoCascade','InfoFlow','Turbulence','err_hete');
