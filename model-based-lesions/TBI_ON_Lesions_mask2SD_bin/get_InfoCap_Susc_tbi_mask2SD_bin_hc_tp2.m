clear all;
outdir='/Volumes/LASA/TBI_OpenNeuro/TBI_openneuro/Hopf_model/TBI_ON_Lesions_Hopf_mask2SD_bin_corr/outputs/Trials/';
addpath(outdir)
...
tbi_cond1=load_condition_InfoCapON_tbi_mask2SD_bin(trials,1);
tbi_cond2=load_condition_InfoCapON_tbi_mask2SD_bin(trials,2);
tbi_cond3=load_condition_InfoCapON_tbi_mask2SD_bin(trials,3);
...
save ('perturbation_tbi_cond1_2SDbin.mat', 'tbi_cond1_infocap','tbi_cond1_suscep')
save ('perturbation_tbi_cond2_2SDbin.mat', 'tbi_cond2_infocap','tbi_cond2_suscep')
save ('perturbation_tbi_cond3_2SDbin.mat', 'tbi_cond3_infocap','tbi_cond3_suscep')
