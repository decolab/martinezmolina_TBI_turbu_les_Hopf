...
load('lesion_mask_2SD.mat') % lesion mask thresholded at 1.5 std and averaged across TBI patients (binary approach)
...
save(sprintf('Wtrials_%03d_%d_%s_ON_tbi_mask2SD_bin.mat',s,condition,measure),'infocapacity','susceptibility');
