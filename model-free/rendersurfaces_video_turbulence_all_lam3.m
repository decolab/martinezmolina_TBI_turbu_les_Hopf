...
addpath(genpath('/Volumes/LASA/TBI_project/Shared_code/Turbulence/TBI_turbulence_current_code/RenderSurface/'))
...
cd (data_path)
    load(data(d).name)
    entropy1_lam3=squeeze(entropy1(9,:,:)); %lambda=0.03
...
for i=1:144
    ...
    % create surface file
    create_schaefer1000_gifti(entropy1_lam3(:,i),['tst']);
