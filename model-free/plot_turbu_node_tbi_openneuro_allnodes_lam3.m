...
t=tiledlayout(2,4);
for i=1:7
    t1 = squeeze(nanmean(hc_con1.Turbulence_node_sub(9,:,:),2));
    t2 = squeeze(nanmean(tbi_con1.Turbulence_node_sub(9,:,:),2));
    C = {t1, t2};
    nexttile
...
title(t,'Turbu all nodes lam3 HCs vs TBI 3-months')
print('Boxplot lam3 Turbu all nodes diff HCs vs TBI 3-months','-dpng')
saveas(gcf,'Boxplot lam3 Turbu all nodes diff HCs vs TBI 3-months','fig')
clear Cmat Cpad
%-----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
for i=1:7
    t1 = squeeze(nanmean(hc_con1.Turbulence_node_sub(9,:,:),2));
    t2 = squeeze(nanmean(tbi_con2.Turbulence_node_sub(9,:,:),2));
    C = {t1, t2};
    nexttile
    maxNumEl = max(cellfun(@numel,C));
    Cpad = cellfun(@(x){padarray(x(:),[maxNumEl-numel(x),0],NaN,'post')}, C);
...
title(t,'Turbu all nodes lam3 HCs vs TBI 6-months')
print('Boxplot lam3 Turbu all nodes diff HCs vs TBI 6-months','-dpng')
saveas(gcf,'Boxplot lam3 Turbu all nodes diff HCs vs TBI 6-months','fig')
clear Cmat Cpad
%%-----------------------------------------------------------------------------------------------------------------------------------------
...
for i=1:7
    t1 = squeeze(nanmean(hc_con1.Turbulence_node_sub(9,:,:),2));
    t2 = squeeze(nanmean(tbi_con3.Turbulence_node_sub(9,:,:),2));
    C = {t1, t2};
    nexttile
    maxNumEl = max(cellfun(@numel,C));
    Cpad = cellfun(@(x){padarray(x(:),[maxNumEl-numel(x),0],NaN,'post')}, C);
...
title(t,'Turbu all nodes lam3 HCs vs TBI 12-months')
print('Boxplot lam3 Turbu all nodes diff HCs vs TBI 12-months','-dpng')
saveas(gcf,'Boxplot lam3 Turbu all nodes diff HCs vs TBI 12-months','fig')
clear Cmat Cpad
