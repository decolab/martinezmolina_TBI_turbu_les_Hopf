...
save (sprintf('turbu_all_measurements_openneuro_tbi_con%d_test.mat',cond), 'LAMBDA','TurbulenceRSN_sub','Turbulence_global_sub', 'Transfer_sub', 'InformationCascade_sub', 'TransferLambda_sub','gKoPRSN','MetaRSN','gKoP','Meta');