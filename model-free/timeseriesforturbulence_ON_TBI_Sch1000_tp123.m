...
tseries_tp1(s, 1)={data_sc1000_openneuro_tbi_tp1};
tseries_tp2(s, 2)={data_sc1000_openneuro_tb_tp2};
tseries_tp3(s, 3)={data_sc1000_openneuro_tb_tp3};
    
    clearvars -except data_path input_path fnames tseries_tp1 tseries_tp2 tseries_tp3
end

cd(input_path)
save('tseries_openneuro_tbi_tp1_sch1000_test.mat', 'tseries_tp1')
save('tseries_openneuro_tbi_tp2_sch1000_test.mat', 'tseries_tp2')
save('tseries_openneuro_tbi_tp3_sch1000_test.mat', 'tseries_tp3')
