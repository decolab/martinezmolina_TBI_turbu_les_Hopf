...
clear all
data_path='/Volumes/LASA/TBI_OpenNeuro/TBI_openneuro/timeseries/preprocessing/hc_tp2_sch400/';
...
for s=1:12
    ...
    for i=1:400 %100 Schaefer nodes
        data_sc400_openneuro_hc_tp2(i, 1:144)=data{1,1267+i}(1:144)';
 
    end

tseries(s, 1)={data_sc400_openneuro_hc_tp2};
    clearvars -except data_path input_path fnames tseries
end

cd(input_path)
save('tseries_openneuro_hc_tp2_sch400.mat', 'tseries')
