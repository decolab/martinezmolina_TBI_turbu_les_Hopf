...
load('tseries_openneuro_hc_tp1_sch400.mat')               % Denoised time-series
...
save (sprintf('turbu_all_measurements_openneuro_hc_tp1_sch400_con%d.mat',cond), 'LAMBDA','TurbulenceRSN_sub','Turbulence_global_sub', 'InformationCascade_sub', 'TransferLambda_sub','Transfer_sub','gKoPRSN','MetaRSN','gKoP','Meta');