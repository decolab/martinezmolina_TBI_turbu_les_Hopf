...
clear all
close all
outdir_HC='/Volumes/LASA/TBI_OpenNeuro/TBI_openneuro/Hopf_model/TBI_homogeneous/outputs/Grange/HC/';
...
optG_hc_tp1=G_range(ioptG_hc);

cd(fullfile(outdir_HC,'optG'))
save('optG_hc_tp1.mat','optG_hc_tp1')
...
xline(optG_hc_tp1, 'Color',[0.7 0.7 0.7], 'LineWidth',1.5)
...
print('Global coupling Fitting Open Neuro TP123 HC TP1 (N=24)','-dpng')
saveas(gcf,'Global coupling Fitting Open Neuro TP123 HC TP1 (N=24)','fig')