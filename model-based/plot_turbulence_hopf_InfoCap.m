clear all;
addpath('/Volumes/LASA/TBI_project/TBI_openneuro/Hopf_model/TBI_replication/outputs/Trials/TBI/');

trials=100;
groups={'hc','tbi_tp1','tbi_tp2','tbi_tp3'};

cond1=load_condition_InfoCapON_tbi(trials,1);
cond2=load_condition_InfoCapON_tbi(trials,2);
cond3=load_condition_InfoCapON_tbi(trials,3);

addpath('/Volumes/LASA/TBI_project/TBI_openneuro/Hopf_model/TBI_replication/outputs/Trials/HC/'); %controls
...
[~,pval_infocap_hctbi1] = ttest2(cond1.infocap_all,cnt.infocap_all); % Two-sample t-Test
[~,pval_infocap_hctbi2] = ttest2(cond2.infocap_all,cnt.infocap_all); % Two-sample t-Test
[~,pval_infocap_hctbi3] = ttest2(cond3.infocap_all,cnt.infocap_all); % Two-sample t-Test

[~,pval_suscep_hctbi1] = ttest2(cond1.suscep_all,cnt.suscep_all); % Two-sample t-Test
[~,pval_suscep_hctbi2] = ttest2(cond2.suscep_all,cnt.suscep_all); % Two-sample t-Test
[~,pval_suscep_hctbi3] = ttest2(cond3.suscep_all,cnt.suscep_all); % Two-sample t-Test
...
figure
subplot(2,1,1)
boxplot([cnt.infocap_all cond1.infocap_all cond2.infocap_all cond3.infocap_all],'labels',groups)
...
subplot(2,1,2)
boxplot([ cnt.suscep_all cond1.suscep_all cond2.suscep_all cond3.suscep_all],'labels',groups)
