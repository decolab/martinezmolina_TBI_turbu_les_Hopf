...
if condition==1
    G=0.4100; %Optimal G weight for healthy controls, manual input
end
...
for sub=1:NSUBSIM
    ...
    %% HERE WE INTRODUCED THE PERTURBATION
...
save(sprintf('Wtrials_%03d_%d_%s_ON_hc.mat',s,condition,measure),'infocapacity','susceptibility');
