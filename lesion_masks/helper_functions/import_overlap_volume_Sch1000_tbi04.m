function overlapvolumecombinedwsubtbi04 = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   OVERLAPVOLUMECOMBINEDWSUBTBI04 = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   OVERLAPVOLUMECOMBINEDWSUBTBI04 = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   overlapvolumecombinedwsubtbi04 = importfile('overlap_volume_combined_wsub-tbi04.txt', 1, 1001);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2023/06/15 17:34:20
...
overlapvolumecombinedwsubtbi04 = table(dataArray{1:end-1}, 'VariableNames', {'VarName1','VarName2'});
