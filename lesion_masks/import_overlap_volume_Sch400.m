function overlapvolumecombined = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   OVERLAPVOLUMECOMBINED = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   OVERLAPVOLUMECOMBINED = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   overlapvolumecombined = importfile('overlap_volume_combined.txt', 1, 4000);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2023/06/15 17:03:19
...
overlapvolumecombined = table(dataArray{1:end-1}, 'VariableNames', {'VarName1','VarName2'});
