...
if condition==1
    G=0.3200; %OptG TBI ses1
elseif condition==2
    G=0.3000; %OptG TBI ses2
elseif condition==3
    G=0.3200; %OptG TBI ses3
end
...
C=C.*lesion_mask_1andhalfSD; % Multiply by lesion mask from tbi patients
...
save(sprintf('Wtrials_%03d_%d_%s_ON_tbi_mask1halfSD_bin.mat',s,condition,measure),'infocapacity','susceptibility');
