...
addpath('/Volumes/LASA/TBI_OpenNeuro/TBI_openneuro/Hopf_model/TBI_ON_Lesions_Hopf_mask2SD_bin/outputs/Grange/');
addpath('/Volumes/LASA/TBI_OpenNeuro/Shared_code/TBI_ON_Lesions_Hopf_mask2SD_bin/');
outdir='/Volumes/LASA/TBI_OpenNeuro/TBI_openneuro/Hopf_model/TBI_ON_Lesions_Hopf_mask2SD_bin/outputs/Grange/optG/';
...
for cond=1:3
    if cond==1
        tbi_cond1=load_condition_tbi_mask2SD_bin(G,cond);
    elseif cond==2
        tbi_cond2=load_condition_tbi_mask2SD_bin(G,cond);
    else 
         tbi_cond3=load_condition_tbi_mask2SD_bin(G,cond);
    end
end
...
cd (outdir)
save('optG_tbi_mask2SD_bin.mat','optG_tbicond1', 'optG_tbicond2','optG_tbicond3')
